...
#ifndef H_RONPAULCOIN_SCRIPT
#define H_RONPAULCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CRonPaulCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, RonPaulCoin always counted CHECKMULTISIGs

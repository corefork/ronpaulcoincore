...
{
    LogPrintf("RonPaulCoinMiner started\n");
    ...
    try { while (true) {
        ...
        LogPrintf("Running RonPaulCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("RonPaulCoinMiner terminated\n");
        throw;
    }
}

void GenerateRonPaulCoins(bool fGenerate, CWallet* pwallet, int nThreads)
{

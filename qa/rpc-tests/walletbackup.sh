...
RONPAULCOIND=${1}/ronpaulcoind
CLI=${1}/ronpaulcoin-cli
...
B4ARGS="-datadir=$D4"
$RONPAULCOIND $RONPAULCOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$RONPAULCOIND $RONPAULCOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $RONPAULCOIND $RONPAULCOINDARGS $B1ARGS &
  B1PID=$!
  $RONPAULCOIND $RONPAULCOINDARGS $B2ARGS &
  B2PID=$!
  $RONPAULCOIND $RONPAULCOINDARGS $B3ARGS &
  B3PID=$!
}
